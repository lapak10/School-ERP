...
<?php echo form_open_multipart('assignment/upload_assignment',array('id'=>'validate-form','class'=>'block-content form'));?>
						<div class="_100">
							<p><label for="textfield">Subject</label><input id="textfield" name="subject" class="required text" type="text" value=""></p>
						</div>
						
						<div class="_100">
							<p><label for="textarea">Description </label><textarea id="textarea" name="description" class="required uniform" rows="5" cols="40"></textarea></p>
						</div>
