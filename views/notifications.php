...
<head>
  ...
  <title>Notifications :: Grape - Professional &amp; Flexible Admin Template</title>
    ...
    <aside id="sidebar">
    	...
    	<nav id="nav">
	    	<ul class="menu collapsible shadow-bottom">
	    		<li><a href="dashboard.html"><img src="img/icons/packs/fugue/16x16/dashboard.png">Dashboard<span class="badge">2</span></a></li>
	    		<li><a href="forms.html"><img src="img/icons/packs/fugue/16x16/application-form.png">Forms</a></li>
	    		<li><a href="table.html"><img src="img/icons/packs/fugue/16x16/table.png">Table</a></li>
	    		<li><a href="charts.html"><img src="img/icons/packs/fugue/16x16/chart.png">Charts</a></li>
	    		<li>
	    			<a href="javascript:void(0);"><img src="img/icons/packs/fugue/16x16/clipboard-list.png">Lists<span class="badge grey">3</span></a>
	    			<ul class="sub">
	    		...
	    		<li><a href="notifications.html" class="current"><img src="img/icons/packs/fugue/16x16/application--exclamation.png">Notifications</a></li>
	    		<li><a href="alert_boxes.html"><img src="img/icons/packs/fugue/16x16/balloons-box.png">Alert Boxes</a></li>
	    		<li><a href="tooltips.html"><img src="img/icons/packs/fugue/16x16/ui-tooltip-balloon.png">Tooltips</a></li>
	    		<li><a href="404.html"><img src="img/icons/packs/fugue/16x16/magnifier--exclamation.png">Error-Page (404)</a></li>
	    		<li><a href="login.html"><img src="img/icons/packs/fugue/16x16/door-open-in.png">Login</a></li>
	    		<li>
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover">Notifications</li>
			</ul>
			...
			<div class="grid_6">
				<div class="block-border">
					<div class="block-header">
						<h1>Notifications Example</h1><span></span>
					</div>
					<div class="block-content">
						<p>Just click a button to display a notification.</p>
						<p>Only <strong>5 notifications</strong> will display at the <strong>same time</strong>. This value is editable.</p>
					</div>
					<div class="block-content">
						<p><a href="javascript:void(0);" id="notification-success" class="button" style="width: 150px; text-align: center;">Success Notification</a></p>
						<p><a href="javascript:void(0);" id="notification-error" class="button" style="width: 150px; text-align: center;">Error Notification</a></p>
						...
						<p><a href="javascript:void(0);" id="notification-warning" class="button" style="width: 150px; text-align: center;">Warning Notification</a></p>
						<p><a href="javascript:void(0);" id="notification-saved" class="button" style="width: 150px; text-align: center;">Saved Notification</a></p>
					</div>
				</div>
			</div>
