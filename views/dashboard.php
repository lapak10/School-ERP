<?php
  	/* Include $common variable on all the other pages before the "<!-- Begin of #main -->" and nothing else
  	 * this includes all the FALTU FOKAT stuff of including the css and html markup.
  	 * 
  	 */
    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<div class="grid_12">
				...
				<div class="alert info"><span class="hide">x</span><strong><?php echo $var;?></strong></div>
			</div>
						...
						<ul class="shortcut-list">
							<li>
								<a href="javascript:void(0);">
									<img src="<?php echo $base_url; ?>assets/img/icons/packs/crystal/48x48/apps/kedit.png">
									Write an Article
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<img src="<?php echo $base_url; ?>assets/img/icons/packs/crystal/48x48/apps/penguin.png">
									User Manager
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<img src="<?php echo $base_url; ?>assets/img/icons/packs/crystal/48x48/apps/wifi.png">
									Control Monitor
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<img src="<?php echo $base_url; ?>assets/img/icons/packs/crystal/48x48/apps/mailreminder.png">
									Check the Mails
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<img src="<?php echo $base_url; ?>assets/img/icons/packs/crystal/48x48/apps/Volume Manager.png">
									Statistics
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<img src="<?php echo $base_url; ?>assets/img/icons/packs/crystal/48x48/apps/terminal.png">
									Manage Console
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<img src="<?php echo $base_url; ?>assets/img/icons/packs/crystal/48x48/apps/knotes.png">
									Notes
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<img src="<?php echo $base_url; ?>assets/img/icons/packs/crystal/48x48/apps/kview.png">
									Manage Images
								</a>
							</li>
						</ul>
