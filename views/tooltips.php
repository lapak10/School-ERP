...
<head>
  ...
  <title>Tooltips :: Grape - Professional &amp; Flexible Admin Template</title>
    ...
    <aside id="sidebar">
    	...
    	<nav id="nav">
	    	<ul class="menu collapsible shadow-bottom">
	    		...
	    		<li><a href="tooltips.html" class="current"><img src="img/icons/packs/fugue/16x16/ui-tooltip-balloon.png">Tooltips</a></li>
    ...
    <div id="main" role="main">
		...
		<div id="main-content">
			...
			<div class="grid_4">
				<div class="block-border">
					<div class="block-header">
						<h1>Tooltip Top</h1><span></span>
					</div>
					<div class="block-content">
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
						<p><a href="javascript:void(0);" rel="tooltip-top" title="Lorem ipsum dolor sit amet."><strong>Hover over this link.</strong></a></p>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
					</div>
				</div>
			</div>
			...
			<div class="grid_4">
				<div class="block-border">
					<div class="block-header">
						<h1>Tooltip Right</h1><span></span>
					</div>
					<div class="block-content">
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
						<p><a href="javascript:void(0);" rel="tooltip-right" title="Lorem ipsum dolor sit amet."><strong>Hover over this link.</strong></a></p>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
					</div>
				</div>
			</div>
			...
			<div class="grid_4">
				<div class="block-border">
					<div class="block-header">
						<h1>Tooltip Bottom</h1><span></span>
					</div>
					<div class="block-content">
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
						<p><a href="javascript:void(0);" rel="tooltip-bottom" title="Lorem ipsum dolor sit amet."><strong>Hover over this link.</strong></a></p>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
					</div>
				</div>
			</div>
			...
			<div class="grid_4">
				<div class="block-border">
					<div class="block-header">
						<h1>Tooltip Left</h1><span></span>
					</div>
					<div class="block-content">
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
						<p><a href="javascript:void(0);" rel="tooltip-left" title="Lorem ipsum dolor sit amet."><strong>Hover over this link.</strong></a></p>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
					</div>
				</div>
			</div>
			...
			<div class="grid_4">
				<div class="block-border">
					<div class="block-header">
						<h1>HTML Tooltip</h1><span></span>
					</div>
					<div class="block-content">
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
						<p><a href="javascript:void(0);" rel="tooltip-html" title="This is a &lt;b&gt;bold&lt;/b&gt; text&lt;br&gt;This is an &lt;i&gt;italic&lt;/i&gt; text&lt;br&gt;This is an &lt;u&gt;underline&lt;/u&gt; text"><strong>Hover over this link.</strong></a></p>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
					</div>
				</div>
			</div>
