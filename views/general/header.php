<!-- Begin of #header -->
    <div id="header-surround"><header id="header">
		...
		<div id="user-info">
			<p>
				<span class="messages">Hello <a href="javascript:void(0);">Administrator</a> ( <a href="javascript:void(0);"><img src="<?php echo $base_url; ?>assets/img/icons/packs/fugue/16x16/mail.png" alt="Messages"> 3 new messages</a> )</span>
