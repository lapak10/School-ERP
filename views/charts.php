...
<head>
  ...
  <title>Charts :: Grape - Professional &amp; Flexible Admin Template</title>
    ...
    <aside id="sidebar">
    	...
    	<nav id="nav">
	    	<ul class="menu collapsible shadow-bottom">
	    		...
	    		<li><a href="charts.html" class="current"><img src="img/icons/packs/fugue/16x16/chart.png">Charts</a></li>
	    		<li>
