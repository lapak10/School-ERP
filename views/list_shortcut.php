...
<head>
  ...
  <title>Shortcut List :: Grape - Professional &amp; Flexible Admin Template</title>
    ...
    <aside id="sidebar">
    	...
    	<nav id="nav">
	    	<ul class="menu collapsible shadow-bottom">
	    		...
	    		<li class="expand">
	    			<a href="javascript:void(0);" class="current"><img src="img/icons/packs/fugue/16x16/clipboard-list.png">Lists<span class="badge grey">3</span></a>
	    			<ul class="sub">
	    				<li><a href="list_block.html">Block Lists</a></li>
	    				<li><a href="list_shortcut.html" class="current">Shortcut List</a></li>
    ...
    <div id="main" role="main">
		...
		<div id="title-bar">
			<ul id="breadcrumbs">
				...
				<li class="no-hover">Shortcut List</li>
			</ul>
			...
			<div class="grid_12">
				<div class="block-border">
					<div class="block-header">
						<h1>Shortcut List</h1><span></span>
					</div>
					<div class="block-content">
						<ul class="shortcut-list">
							<li>
								<a href="javascript:void(0);">
									<img src="img/icons/packs/onebit/48x48/onebit_19.png">
									Write an Article
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<img src="img/icons/packs/onebit/48x48/onebit_18.png">
									User Manager
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<img src="img/icons/packs/onebit/48x48/onebit_63.png">
									Control Monitor
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<img src="img/icons/packs/onebit/48x48/onebit_41.png">
									Check the Mails
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<img src="img/icons/packs/onebit/48x48/onebit_66.png">
									Statistics
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<img src="img/icons/packs/onebit/48x48/onebit_72.png">
									Manage Console
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<img src="img/icons/packs/onebit/48x48/onebit_85.png">
									What to do
								</a>
							</li>
							<li>
								<a href="javascript:void(0);">
									<img src="img/icons/packs/onebit/48x48/onebit_131.png">
									Manage Images
								</a>
							</li>
						</ul>
